...
-- Description:	Delete Identification Type
-- =============================================
...
CREATE OR ALTER PROCEDURE IdentificationType_DeleteType(
    -- Parameters
    @id INT
)
AS
BEGIN
    ...
    BEGIN TRY
        ...
        UPDATE Payroll.dbo.IdentificationType
        SET IdentificationType.visible = 0
        WHERE IdentificationType.id = @id
