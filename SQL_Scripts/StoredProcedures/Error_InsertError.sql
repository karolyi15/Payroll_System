...
-- Description:	Insert Error Payroll System
-- =============================================
...
CREATE OR ALTER PROCEDURE Error_InsertError(
	--Parameters
	@error_number varchar(64),
	@error_severity varchar(64),
	@error_state varchar(64),
	@error_message varchar(64),
	@error_line varchar(64)
)	
AS
BEGIN
	-- Settings
    ...
    BEGIN TRY
    	-- Inserts New Error Into Table
    	INSERT INTO Payroll.dbo.Error (number, severity, state, message, line)
    	VALUES (@error_number, @error_severity, @error_state, @error_message, @error_line)
